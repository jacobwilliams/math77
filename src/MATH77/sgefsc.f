      subroutine SGEFSC(A,LDA,N,B,LDB,NB,IPVT,RCOND,Z)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 1994-11-11 SGEFSC  Krogh   Declared all vars.
C>> 1994-10-20 SGEFSC Krogh  Changes to use M77CON
C>> 1987-08-18 SGEFSC Lawson  Initial code.
c--S replaces "?": ?GEFSC, ?GECO, ?GESLD
c
...
c     ------------------------------------------------------------------
c     Subroutines called: SGECO, SGESLD
c     ------------------------------------------------------------------
      integer LDA, N, LDB, NB, IPVT(N), J
      real             A(LDA,N), B(LDB,*), Z(N), RCOND, ZERO

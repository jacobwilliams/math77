      subroutine DGED(A,LDA,N,IPVT,DET)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 2001-05-25 DGED Krogh Minor change for making .f90 version.
c>> 1996-03-30 DGED Krogh  Added external statement.
C>> 1994-10-20 DGED Krogh  Changes to use M77CON
C>> 1992-04-14 DGED CLL Using (*) in dimensions rather than (1).
C>> 1990-01-19 CLL added test to avoid looping when some A(I,I) = 0.
C>> 1987-08-20 DGED   Lawson  Initial code.
c--D replaces "?": ?GED
C
C     DGED computes the determinant of the matrix A
...
c     ------------------------------------------------------------------
c     Subprograms referenced: D1MACH
C     ------------------------------------------------------------------
      external D1MACH
      integer LDA,N,IPVT(*),  I, K
      double precision D1MACH
      double precision A(LDA,*),DET(2), ONE, ZERO, DT1, ATERM
      double precision STEP, TBIG, TSMALL, FBIG, FSMALL, TEN, DT2
      logical FIRST

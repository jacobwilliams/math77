...
C>> 2000-12-03 DRNSGB Krogh  Removed references to IV(RESTOR).
C>> 1998-10-29 DRNSGB Krogh  Moved external statement up for mangle.
c>> 1994-10-20 DRNSGB Krogh  Changes to use M77CON
c>> 1990-06-12 DRNSGB CLL @ JPL
...
C
c--D replaces "?": ?RNSGB,?ITSUM,?IVSET,?L7ITV,?L7SVN,?L7SVX,?Q7APL
...
C
 40   IV(IV1SAV) = IV(1)
      IV(1) = abs(IV1)
c      IF (IV(RESTOR) .EQ. 2 .AND. L .GT. 0) CALL DV7CPY(L, V(CSAVE1), C)
      GO TO 999
C

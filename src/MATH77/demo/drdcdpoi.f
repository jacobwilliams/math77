      program DRDPOI
c>> 2001-05-25 DRDCDPOI Krogh Minor change for making .f90 version.
c>> 1996-05-28 DRDCDPOI Krogh  Changed Fortran 90 code.
c>> 1994-10-19 DRDCDPOI Krogh  Changes to use M77CON
c>> 1994-07-06 DRDCDPOI WVS set up for chgtyp
c
c     Evaluate the Probability Function Q(n,lamda) of the Poisson
c     distribution by using DCDPOI.
c
c--D replaces "?": DR?POI, DR?CDPOI, ?cdpoi, ?gamik

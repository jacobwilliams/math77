      SUBROUTINE SC2BAS(X,NDERIV,ISEG,NEWSEG, B,NB,P)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 1994-11-11 SC2BAS Krogh  Declared all vars.
C>> 1994-10-20 SC2BAS Krogh  Changes to use M77CON
C>> 1987-12-09 SC2BAS Lawson Initial code.
c--S replaces "?": ?C2BAS
c
...
c
      ...
      real             U(8), B(NB), P(4), C6, C18, C36, CS
      real             FLNSEG, H, SCALE, X, XS
      logical NEWSEG
      parameter(C6 = 6.0E0, C18 = 18.0E0, C36 = 36.0E0)
      save  U, SCALE
c     ------------------------------------------------------------------
      MB=NB

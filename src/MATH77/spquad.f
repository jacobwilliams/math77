      real             function SPQUAD(KORDER, NPC, XI, PC, X1, X2)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 1994-10-20 SPQUAD Krogh  Changes to use M77CON
c>> 1992-11-12 SPQUAD C. L. Lawson, JPL  Saving IL1 and IL2.
...
C
c  OUTPUT:
c     SPQUAD - Integral of the piecewise polynomial from X1 to X2.
c     ------------------------------------------------------------------
...
c     ------------------------------------------------------------------
c--S replaces "?": ?PQUAD, ?SFIND
c     ------------------------------------------------------------------
      integer II, IL1, IL2, IM, KORDER, LEFT, MODE, NPC
      real             A, AA, B, BB, DENOM, DX, ONE
      real             Q, S, SS(2), PC(KORDER,NPC)
      real             X, X1, X2, XI(NPC+1)
      real             ZERO
...
C
      ...
      call SSFIND ( XI, 1, NPC+1, AA, IL1, MODE )
      call SSFIND ( XI, 1, NPC+1, BB, IL2, MODE )
      do 50 LEFT=IL1,IL2
         if(LEFT .eq. IL1) then
            A=AA
         else

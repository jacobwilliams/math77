      subroutine CGEFS(A,LDA,N,B,LDB,NB,IPVT,INFO)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 1994-11-11 CGEFS  Krogh   Declared all vars.
C>> 1987-08-11 CGEFS  Lawson  Initial code.
c
...
c           not be computed.
c     ------------------------------------------------------------------
c     Subprograms called: CGEFA, CGESLD
c     ------------------------------------------------------------------
      integer LDA, N, LDB, NB, IPVT(N), INFO, J
      complex A(LDA,N), B(LDB,*)
c     ------------------------------------------------------------------

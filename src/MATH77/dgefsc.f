      subroutine DGEFSC(A,LDA,N,B,LDB,NB,IPVT,RCOND,Z)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 1994-11-11 DGEFSC  Krogh   Declared all vars.
C>> 1994-10-20 DGEFSC Krogh  Changes to use M77CON
C>> 1987-08-18 DGEFSC Lawson  Initial code.
c--D replaces "?": ?GEFSC, ?GECO, ?GESLD
c
...
c     ------------------------------------------------------------------
c     Subroutines called: DGECO, DGESLD
c     ------------------------------------------------------------------
      integer LDA, N, LDB, NB, IPVT(N), J
      double precision A(LDA,N), B(LDB,*), Z(N), RCOND, ZERO

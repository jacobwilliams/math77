...
c>> 2001-11-04 SGBFA Krogh  Fixes for F77 and conversion to single
c--S replaces "?": ?GBFA, ?GBCO, ?AXPY, ?SCAL, I?AMAX
c      IMPLICIT NONE
C***BEGIN PROLOGUE  SGBFA
C***PURPOSE  Factor a band matrix using Gaussian elimination.
C***LIBRARY   SLATEC (LINPACK)
C***CATEGORY  D2A2
C***TYPE      DOUBLE PRECISION (SGBFA-S, SGBFA-D, CGBFA-C)
...
C***ROUTINES CALLED  SAXPY, SSCAL, ISAMAX

      SUBROUTINE DTGPRG(X,Y,NP,TRIANG,B,NB,NT)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 1997-07-01 DTGPRG Krogh Remove MB (CLL suggestion)
c>> 1997-06-15 DTGPRG CLL Now assuming list in B() is circular.
c>> 1996-06-24 DTGPRG  Krogh   Format changes for conversion to C.
c>> 1996-03-30 DTGPRG  Krogh   MIN0 => MIN
C>> 1996-02-02 DTGPRG CLL
C>> 1995-09-26 DTGPRG CLL Editing for inclusion into MATH77.
C

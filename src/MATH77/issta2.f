...
c++ END
      subroutine ISSTA2(ISTATS, XSTATS, IHIST, ILOW, NCELLS)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 2001-03-30 ISSTA2 Krogh  Change for C conversion.
c>> 1995-07-09 ISSTA2 Krogh  Small modification for C conversion.
c>> 1994-10-20 ISSTA2 Krogh  Changes to use M77CON
c>> 1994-06-22 ISSTA2 CLL  Changed name to I[D/S]STA2.
c>> 1989-04-26 ISTAT2 CLL  Changed to use SPRPL instead of PRPL.
...
c++ CODE for .C. is inactive
c%%         sprpl(  (float)( Ihist[1] ), '*', image, NLEN, 0.e0,
c%%            flmaxc, TRUE );
...
c++ End
      ...
      do 30 I=2,NCELLS-1
         IVAL = IVAL + 1
c++ CODE for .C. is inactive
c%%         sprpl(  (float)( Ihist[i] ), '*', image, NLEN, 0.e0,
c%%            flmaxc, TRUE );
c++ CODE for ~.C. is active
...
c++ CODE for .C. is inactive
c%%         sprpl(  (float)( Ihist[ncells] ), '*', image, NLEN,
c%%           0.e0, flmaxc, TRUE );
c++ CODE for ~.C. is active

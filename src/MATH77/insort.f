C++ CODE for INSORT_VER = INSRTX is inactive
C      subroutine INSRTX (COMPAR,N,LIST,LIST1)
C++ CODE for INSORT_VER = INSORT is active
...
c>> 1998-01-21 INSORT Krogh Upper limit on "do 30..." changed to nheads.

      subroutine DEVBH(A, LDA, N, LOW, IGH, IFLAG, SCALE)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 2001-05-25 DEVBH  Krogh Minor change for making .f90 version.
c>> 1996-03-30 DEVBH  Krogh  Added external statement.
c>> 1994-10-20 DEVBH  Krogh  Changes to use M77CON
c>> 1992-04-23 DEVBH  CLL  Declaring all variables.
c>> 1992-04-22 DEVBH  Krogh Removed unused label 80.
c>> 1991-10-25 DEVBH  Krogh Initial version, converted from EISPACK.
c
...
c     ------------------------------------------------------------------
      ...
      integer LA,KP1,MM1
      double precision A(LDA,N),SCALE(N)
      double precision C,F,G,R,S,B2,BASE
...
c     .......... interchange rows and columns of A ..........
  ...
  320    continue
c     .......... end interchange ..........
  330    if (X .eq. 0.0D0) go to 380
         do 360 I = M + 1, IGH
            Y = A(I,MM1)
            if (Y .eq. 0.0D0) go to 360
            Y = Y / X
            A(I,MM1) = Y
            do 340 J = M, N
               A(I,J) = A(I,J) - Y * A(M,J)

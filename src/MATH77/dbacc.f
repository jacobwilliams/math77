      SUBROUTINE DBACC (G,LDG,NB,IR,MT,JT,JTPREV, IERR2)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 1994-10-20 DBACC Krogh  Changes to use M77CON
C>> 1992-06-16 DBACC CLL
C>> 1989-10-20 CLL
C>> 1987-11-24 DBACC  Lawson  Initial code.
...
c     ------------------------------------------------------------------
      ...
      double precision G(LDG,NB+1), ZERO, UPARAM
...
C                                             ALG. STEP 20
      do 80 I=1,KH1
   80   CALL DHTCC (1,I,max(I+1,ISTEP),MH,G(JTPREV,I),UPARAM,

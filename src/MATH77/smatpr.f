      subroutine SMATPR(A, IDIMA, M, N, TEXT, LWIDTH, LUNIT, NUMDIG)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
C>> 2000-12-01 SMATPR Krogh Removed unused parameter METXTF.
C>> 1994-11-11 SMATPR Krogh Declared all vars.
c>> 1994-10-20 SMATPR Krogh Added M77CON code.
c>> 1992-05-03 SMATPR Krogh Convert to use MESSFT for Fortran text.
c>> 1992-04-08 SMATPR Krogh Replaced dummy K with MACT in ?MESS calls.
c>> 1991-11-22 SMATPR F. Krogh   Initial code
c
c++I DEFAULT MSTOR=2, MACT1D=7, TAIL=", LUNIT"
c++  DEFAULT MSTOR=4, MACT1D=9, TAIL=", LUNIT, NUMDIG"
c++  REPLACE ", LUNIT, NUMDIG" = TAIL
c--S replaces "?": ?MATPR, ?MESS
c

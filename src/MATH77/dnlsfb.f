      SUBROUTINE  DNLSFB(N, P, L, ALF, B, C, Y, DCALCA, INC, IINC, IV,
     1                  LIV, LV, V)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 1996-04-27 DNLSFB Krogh  Changes to get desired C prototypes.
c>> 1994-10-20 DNLSFB Krogh  Changes to use M77CON
c>> 1990-07-02 DNLSFB CLL @ JPL
c>> 1990-06-12 CLL @ JPL
c>> 1990-02-14 CLL @ JPL
*** from netlib, Fri Feb  9 13:10:09 EST 1990 ***
c--D replaces "?": ?NLSFB,?CALCA,?IVSET,?RNSGB,?V2AXY,?V7CPY,?V7SCL
C
...
C
      ...
      DOUBLE PRECISION ALF(P), C(L), B(2,P), V(LV), Y(N)
C
C  ***  PARAMETERS  ***
C
...
C  DCALCA (IN)  SUBROUTINE TO COMPUTE A MATRIX.
...
C
      EXTERNAL DIVSET, IDSM, DRNSGB,DV2AXY,DV7CPY, DV7SCL
C
...
C
 ...
 170        X0I = XSAVE0 + I
            V(X0I) = XI1
 180        CONTINUE
C%%      (*dcalca)( n, p, l, &V[xsave1], &nf, &V[da1] );
         CALL DCALCA(N, P, L, V(XSAVE1), NF, V(DA1))

      subroutine SVECPR(V, N, TEXT, LWIDTH, LUNIT, NUMDIG)
c Copyright (c) 1996 California Institute of Technology, Pasadena, CA.
c ALL RIGHTS RESERVED.
c Based on Government Sponsored Research NAS7-03001.
c>> 2010-02-22 SVECPR Krogh Initliazed TTEXT to avoid compiler worrirs.
C>> 2000-12-01 SVECPR Krogh Removed unused parameter METXTF.
C>> 1994-11-11 SVECPR Krogh Declared all vars.
c>> 1994-10-20 SVECPR Krogh Added M77CON code.
c>> 1992-05-03 SVECPR Krogh Convert to use MESSFT for Fortran text.
c>> 1992-04-08 SVECPR Krogh Replaced dummy K with MACT in ?MESS call.
c>> 1991-11-22 SVECPR F. Krogh   Initial code
c++I DEFAULT MACT1D=3, TAIL=", LUNIT"
c++  DEFAULT MACT1D=5, TAIL=", LUNIT, NUMDIG"
c++  REPLACE ", LUNIT, NUMDIG" = TAIL
c--S replaces "?": ?VECPR, ?MESS
c
c     *****     Formal Arguments     ***********************************
c
